...
@property (nonatomic, strong) Artists *artists;
...
- (void)viewDidLoad
{
    ...
    self.artists = [[Artists alloc] init];
}
...
//                                  Artists *artz = [[Artists alloc] init:json[@"data"]];
//                                  NSLog(@"\n----------------\nartists: %@\n----------------\n", artz);
                                  dispatch_async(dispatch_get_main_queue(), ^{
                                      
//                                      self.artists = artz.list;
                                      [self.collectionView reloadData];
                                  });
                              }
                          }];
...
{
    return self.artists.list.count;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *artistDictionary = [self.artists.list objectAtIndex:indexPath.row];
